...
lxc init ubuntu:18.04 web2 --target clienteUbuntu2
lxc init ubuntu:18.04 backup2 --target clienteUbuntu2
...
lxc exec backup2 -- apt-get install apache2 -y
...
lxc config device add web2 myport80 proxy listen=tcp:172.42.42.103:5080 connect=tcp:127.0.0.1:80
lxc config device add backup2 myport80 proxy listen=tcp:172.42.42.103:6080 connect=tcp:127.0.0.1:80

echo "reiniciar apache2"
lxc exec web2 -- systemctl restart apache2
lxc exec backup2 -- systemctl restart apache2
